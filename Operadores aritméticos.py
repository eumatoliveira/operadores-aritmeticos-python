...
#Os operadores aritméticos mais comuns incluem adição (+), subtração (-), multiplicação (*), divisão (/), divisão inteira (//), resto da divisão (%), potência (**), raiz quadrada e raiz cúbica.
z = 2 * (0 + 2)
print(z)
